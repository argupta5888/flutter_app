        ...
        return BlocBuilder<LocationBloc, LocationState>(
          builder: (context, locationState) {
            ...
            final distance = locationState.hasLocation
                ? locationState.formattedDistance(food.restaurantLat, food.restaurantLng)
                : '--';
            final estTime = locationState.hasLocation
                ? locationState.estimatedTime(food.restaurantLat, food.restaurantLng)
                : food.prepTime;
                              ...
                              child: Row(
                                ...
                                children: [
                                  _StatTile(
                                      icon: '⭐',
                                      value: '${food.rating}',
                                      label: '${food.reviewCount} reviews'),
                                  _HDivider(),
                                  _StatTile(
                                      icon: '📍',
                                      value: distance,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _RoutePoint(
                                        ...
                                        color: Colors.blue,
                                        label: 'Your Location',
                                        sublabel: locationState.userAddress),
                                    _RouteLine(),
                                    _RoutePoint(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        context.read<CartBloc>().add(CartItemAdded(food));
...
class _StatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(children: [
    ...
    const SizedBox(height: 4),
    Text(value, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: AppTheme.textPrimary)),
